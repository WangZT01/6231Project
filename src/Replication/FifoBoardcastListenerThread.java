...
/**
 ...
 @author Tom Austin
 */
public class FifoBoardcastListenerThread extends Thread
{
    //RB process that this class corresponds to.
    private FifoBoardcastProcess fbp;
    ...
    /**
     ...
     @param fbp  Process that this thread belongs to.
     @param address  Address of the broadcast group.
     @param socketNum  Socket on which to listen.
     */
    public FifoBoardcastListenerThread(FifoBoardcastProcess fbp, InetAddress address, int socketNum)
    {
        this.fbp = fbp;
